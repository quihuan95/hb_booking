...
<head>
  ...
  <meta name="description" property="og:description"
    content="Phòng ở khách sạn giá rẻ trực tuyến thương hiệu HoaBinh Booking lấy chất lượng đặt lên hàng đầu sẽ không làm bạn thất vọng." />
...
<body>
  ...
  <div class="toppages">
            ...
            <div class="___mn">
              ...
              <div class="ul_right">
                <ul>
                  <li x-data="{
                      openModalLang: false,
                      selectedLang: '{{ session('locale', 'vi') }}',
                      changeLang(lang) {
                          this.selectedLang = lang;
                          window.location.href = '/change-language/' + lang;
                      }
                  }" class="tw-flex tw-relative tw-items-center tw-h-[36px] tw-mr-3">
                    <!-- Nút chọn ngôn ngữ (hiển thị cờ) -->
                    <div x-on:click="openModalLang = !openModalLang" class="tw-relative tw-h-6 tw-w-10">
                      <template x-if="selectedLang === 'en'">
                        <img class="tw-absolute tw-h-full tw-w-full tw-object-cover" src="{{ asset('photos/flags/usa.png') }}" alt="usa_flag">
                      </template>
                      <template x-if="selectedLang === 'vi'">
                        <img class="tw-absolute tw-h-full tw-w-full tw-object-cover" src="{{ asset('photos/flags/vietnam.png') }}" alt="vietnam_flag">
                      </template>
                    </div>

                    <!-- Danh sách chọn ngôn ngữ -->
                    <div x-on:click.outside="openModalLang = false" x-show="openModalLang"
                      class="tw-h-fit tw-w-fit tw-px-2 tw-py-2 tw-bg-white tw-shadow tw-rounded tw-absolute tw-top-[100%]">
                      <div x-on:click="changeLang('en')" class="tw-flex tw-items-center tw-gap-x-3 tw-cursor-pointer hover:tw-bg-slate-100 tw-p-1">
                        <img class="tw-h-8 tw-object-contain" src="{{ asset('photos/flags/usa.png') }}" alt="usa_flag">
                        <div class="tw-whitespace-nowrap">{{ __('menu.English') }}</div>
                      </div>
                      <div x-on:click="changeLang('vi')" class="tw-flex tw-items-center tw-gap-x-3 tw-cursor-pointer hover:tw-bg-slate-100 tw-p-1">
                        <img class="tw-h-8 tw-object-contain" src="{{ asset('photos/flags/vietnam.png') }}" alt="vietnam_flag">
                        <div class="tw-whitespace-nowrap">{{ __('menu.Vietnamese') }}</div>
                      </div>
                    </div>
                  </li>

                  <li>
                    <a rel="nofollow" href="{!! route('home.partnership') !!}">
                      <img alt="" src="https://hoabinhbooking.test/uploads/handshake.png" style=" width: 20px; margin-right: 5px; color: #fff;">
                      {{ __('menu.Connect with us') }}
                    </a>
                  </li>
                  <li>
                    <div class="user_box">
                      <div id="acc_box" class="acc_box">
                        <a onclick="fnAccount()" href="javascript:void(0);"><i class="fa fa-user-circle-o" aria-hidden="true"></i> {{ __('menu.Account') }} <i
                            class="fa fa-angle-down"></i></a>
                        <div class="acc_box_2" id="acc_box_2" style="height: 0px;">
                          <div class="acc_box_3">
                            <p style="text-align: center;width:100%;margin: 0px;"><a style="width: 92%;margin: 15px 10px;color: #fff;" href="{!! route('home.partnership') !!}"
                                class="btn btn-primary">{{ __('menu.Login') }}</a></p>
                            <p style="text-align: center;width:100%;font-size: 11px;">{{ __('menu.Don\'t have an account?') }} <a class="a_acc" style="color: blue;"
                                href="{!! route('home.partnership') !!}">{{ __('menu.Sign in') }}</a> {{ __('menu.now') }}</p>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <div class="MuiBox-root jss16 jss5">
      ...
      <video width="100%" height="488px" type="video/mp4" autoplay="" muted="" loop="">
        <source src="frontend/css/images/video-hbbooking-119.mp4">Your browser does not support the video tag.
      </video>
    </div>
    <div class="jsc11">
      @include('inc.search')
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="box_intro">
          <span class="MuiBox-root jss163"><img src="https://storage.googleapis.com/tripi-assets/mytour/icons/icon_total_hotel.svg" alt="logo_total_hotel"
              style="width:52px;height:52px"></span>
          <div class="MuiBox-root jss164 jss160"><span class="MuiBox-root jss165">Hơn 8000+ khách sạn dọc Việt Nam</span><span class="MuiBox-root jss166 jss159">Hàng nghìn khách
              sạn, đặc biệt là 4 sao và 5 sao, cho phép bạn thoải mái lựa chọn, giá cạnh tranh, phong phú.</span></div>
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="box_intro">
          <span class="MuiBox-root jss163"><img src="https://storage.googleapis.com/tripi-assets/mytour/icons/icon_best_price.svg" alt="logo_total_hotel"
              style="width:52px;height:52px"></span>
          <div class="MuiBox-root jss164 jss160"><span class="MuiBox-root jss165">Giá tốt sát ngày</span><span class="MuiBox-root jss166 jss159">Cam kết giá tốt nhất khi đặt gần
              ngày cho chuyến đi của bạn.</span></div>
        </div>
      </div>
      <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="box_intro">
          <span class="MuiBox-root jss163"><img src="https://storage.googleapis.com/tripi-assets/mytour/icons/icon_support_247.svg" alt="logo_total_hotel"
              style="width:52px;height:52px"></span>
      ...
      <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="box_intro">
          <span class="MuiBox-root jss163"><img src="https://storage.googleapis.com/tripi-assets/mytour/icons/icon_payment.svg" alt="logo_total_hotel"
              style="width:52px;height:52px"></span>
          <div class="MuiBox-root jss164 jss160"><span class="MuiBox-root jss165">Thanh toán dễ dàng, đa dạng</span><span class="MuiBox-root jss166 jss159">Bao gồm thêm chuyển
              khoản ngân hàng và tiền mặt tại cửa hàng.</span></div>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="f__b__l">
              <div class="f__b__l_1_1">
                <a href="{!! route('khachsan.details', [$v->slug]) !!}">
                  {!! \App\Models\FileHelper::isImgs($v->image_id) !!}
                </a>
              </div>
              <div class="f__b__l_1_2">
                <h3><a href="{!! route('khachsan.details', [$v->slug]) !!}">{!! $v->title !!}</a></h3>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="destination-item ">
              <a href="https://hoabinhbooking.test/k/phu-quoc">
                <div class="image"
                  style="background: url(https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Bai-sao-phu-quoc-tuonglamphotos.jpg/1200px-Bai-sao-phu-quoc-tuonglamphotos.jpg)">
                  <div class="effect"></div>
                  <div class="content">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="bi_quyet_du_lich_8811">
                <div class="bi_quyet_du_lich_8816">
                  <a href="{!! route('news.details', [$vch->slug]) !!}"><img alt="{!! $vch->title !!}" src="{!! $vch->picture !!}" /></a>
                </div>
                <div class="bi_quyet_du_lich_8813">
                  <h3><a href="{!! route('news.details', [$vch->slug]) !!}">{!! $vch->title !!}</a></h3>
                </div>
              </div>
            </div>
            <?php	
  ...
  <div class="bravo_footer"
    style="background: url(https://hoabinhbooking.test/images/bgfoot-6991.jpeg) no-repeat top center;padding: 5px 0px 0px 0px;background-size: 100% 100% !important;">
    <div class="h35"></div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 col-md-12">
            ...
            <div
              style="width:100%;clear:both;color:#fff;line-height
			ĐKKD: 0102720141<br>

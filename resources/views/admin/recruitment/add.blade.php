	  ...
	  <div class="lang-content-box">
		 <div class="panel">
		  ...
		  <div class="panel-body">
			...
			<div class="panel-body">
									<form role="form" method="post" action="{!! route('admin.rec.create') !!}" enctype="multipart/form-data">
										{{ csrf_field() }}
													...
													<div class="row">
													  ...
													  <div class="col-md-4 col-sm-4 col-xs-12">
														  ...
														  <div class="sub-title">Địa điểm làm việc</div>
															<div>
															  <input type="text" class="form-control" id="work_location" name="work_location" value="" />
															</div>
															<div class="sub-title">Nhóm ngành nghề</div>
															<div>
															  <input type="text" class="form-control" id="industry_group" name="industry_group" value="" />
															</div>
															...
															<div>
															  <input type="text" class="form-control" id="form_of_work" name="form_of_work" value="" />
															</div>

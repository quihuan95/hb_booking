...
<div style="width:100%;height:1px;clear:both;"></div>
	...
	<script src="https://hoabinhbooking.test/dist/admin/js/manifest.js?_ver=1.4.0"></script>
	<script src="https://hoabinhbooking.test/dist/admin/js/vendor.js?_ver=1.4.0"></script>
	<script src="https://hoabinhbooking.test/dist/admin/js/app.js?_ver=1.4.0"></script>
	<script src="https://hoabinhbooking.test/libs/select2/js/select2.min.js"></script>
	<script src="https://hoabinhbooking.test/libs/bootbox/bootbox.min.js"></script>

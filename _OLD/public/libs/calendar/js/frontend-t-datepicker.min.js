(function ($) {
    "use strict";
    var todayCu = new Date($('#hdCheckinFirst').val());
    var nextDay=new Date($('#hdCheckoutFirst').val());
    ...
    var Defaults = {
        ...
        numCalendar: 2,
        titleCheckIn: "Ngày đến",
        titleCheckOut: "Ngày về",
        titleToday: "Hôm nay",
        titleDateRange: "đêm",
        titleDateRanges: "đêm",
        titleDays: ["T2", "T3", "T4", "T5", "T6", "T7", "CN"],
        titleMonths: ["Tháng 01", "Tháng 02", "Tháng 03", "Tháng 04", "Tháng 05", "Tháng 06", "Tháng 07", "Tháng 08", "Tháng 09", "Tháng 10", "Tháng 11", "Tháng 12"],
        titleMonthsLimitShow: 9,
        replaceTitleMonths: null,
        showDateTheme: null,
        iconArrowTop: true,
        iconDate: '<img alt="" src="https://hoabinhbooking.com/public/icon/icons-calendar.jpg" style="width:15px;margin-bottom: 3px;" />',
        arrowPrev: "&#x276E;",
        arrowNext: "&#x276F;",
        toDayShowTitle: true,
        ...
        //dateCheckIn: '03/07/2021',
        //dateCheckOut: '04/07/2021',
        dateCheckIn: dateCurrent,
        dateCheckOut: dateNext,
        startDate: null,
        endDate: null,
        limitPrevMonth: 0,
        limitNextMonth: 999,

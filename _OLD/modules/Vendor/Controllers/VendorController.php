...
/*
	       ...
	       $requestMdl = new VendorRequests();
	
			$requestMdl->fullname = 'louis';
			$requestMdl->email = 'louis.standbyme@gmail.com';
			$requestMdl->request = '2434242344';
			$requestMdl->save();
*/
    ...
    public function request(Request $request){
        ...
        $messages = [
            'email.required'      => __('Email is required field'),
            'email.email'         => __('Email invalidate'),
            'fullname.required' => __('The first name is required field')
        ];
	    ...
	    try {
			...
			$requestMdl->fullname = $request->input('fullname');
			$requestMdl->email = $request->input('email');
			$requestMdl->request = $request->input('request');
			$requestMdl->phone = $request->input('phone');
			$requestMdl->save();

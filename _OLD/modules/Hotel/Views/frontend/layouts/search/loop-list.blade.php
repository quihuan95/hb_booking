...
-->
				 ...
				 @php
				  echo cut_string($translation->content, 520, '...'); @endphp
                </div>
            </div>
        @endif
        <div class="location">
        ...
        <div class="g-price">
            ...
            <div class="price">
                    <?php if($row->sale_price!=null){
                        echo '<span class="text-price"><span style="text-decoration: line-through;">'.number_format($row->price).'</span><sup>đ</sup></span><br/>';
                    }?>
                <span class="text-price">{{ $row->display_price }}<sup>đ</sup><span class="unit">{{__("/night")}}</span></span>
            </div>

    ...
    <div class="row">
        <div class="col-md-6">
         ...
         <div class="col-md-6">
            <div class="form-group">
                <label>View </label>
                <input type="text"  value="{{$row->view}}"  placeholder="View" name="view" class="form-control">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label>Kiểu gường </label>
                <input type="text"  value="{{$row->bed_type}}"  placeholder="Kiểu Giường: King/ Queen/ Double hoặc Twin" name="bed_type" class="form-control">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">

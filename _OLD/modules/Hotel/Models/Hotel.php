        ...
        foreach($rooms as $room){
            if($room->isAvailableAt($filters)){
                $res[] = [
                    ...
                    'booking_buttom'=>'<a href="/vi/dat-phong-khach-san/'.$room->parent_id.'/'.$room->id.'" class="submit btn btn-primary">Đặt phòng ngay </a>',//<i v-show="onSubmit" class="fa fa-spinner fa-spin"></i>

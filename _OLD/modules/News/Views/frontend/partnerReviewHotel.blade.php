...
{!! \Modules\Media\Helpers\FileHelper::imgGallery($data->gallery) !!}
@endif
...
<p>&nbsp;</p>      
    ...
    <div class="row" style="margin-bottom:15px;">
      ...
      <p style="text-align:center;">
        <a style="font-size: 20px;padding: 5px 35px;" class="btn btn-success btn-sm"  href="{!! route('approval.hotel',array($data->id)) !!}"><i class="fa fa-check-circle" aria-hidden="true"></i> CHẤP NHẬN DUYỆT PHÒNG</a>
      </p>
            ...
            $(document).on('click','#btnSearch',function(){
                ...
                for(var i=0;i<=numDay1;i++){
                    ...
                    //if(day22!=''){
                        ...
                        strContent3+='<div class="list-cell '+available_class+'"><div class="text_file"><input type="number" min="0" '+realPro+' onchange="fnSave();" id="phongdeban_'+days2+'" value="'+day223[0]+'"/></div></div>';
                        strContent4+='<div class="list-cell">&nbsp;</div>';
                        strContent5+='<div class="list-cell '+available_class+'"><div class="text_file"><input type="number" min="100000" '+realPro+' onchange="fnSave();" id="standard_rate_'+days2+'" value="'+day223[1]+'"/></div></div>';
                        strContent6+='<div class="list-cell '+available_class+'"><div class="text_file"><input type="number" min="100000" '+realPro+' onchange="fnSave();" id="refundable_'+days2+'" value="'+day223[2]+'"/></div></div>';
                    /*}else{
                        strContent+='<div class="list-cell">'+days1+'</div>';
                        strContent2+='<div class="list-cell unavailable">&nbsp;</div>';
                ...
                function fnSaveMultiRoom(){
                    ...
                    for(var i=0;i<=numDay1;i++){
                        ...
                        if(fnCheckThu(current_thu)){
                            str_info+='vvv'+days2+'vAz';
                        }else{
                            str_info+=$('#soluongphongmulti').val()+'v'+$('#pricePhongMulti').val()+'v'+$('#refundable_'+days2).val()+'v'+days2+'vAz';
                        }
...
$(document).on('click','#btnSaveRoom',function(){ 
    if($('#soluongphongmulti').val()==''){ $('#soluongphongmulti').css("border","solid 1px red"); return; }
    else{ $('#soluongphongmulti').css("border","none"); }
    if($('#pricePhongMulti').val()==''){ $('#pricePhongMulti').css("border","solid 1px red"); return; }
   ...
   function fnRoomChange(){
       ...
       var url1='https://hoabinhbooking.com/vi/cmscpanel/editHotel/'+_HotelID+'?tab=5&room_id='+_Fk_list_id;
       location.href = url1;
   }
...
<p></p>
<label><input type="radio" id="rdoMoPhong" name="rdoModongphong" value="1"/> Mở phòng</label>
&nbsp;&nbsp;&nbsp;
<label><input type="radio" id="rdoDongPhong" name="rdoModongphong" value="1"/> Đóng phòng</label>
</p>
<hr/>
<p>

...
<div class="bravo_footer" style="background: url(https://hoabinhbooking.com/public/images/bgfoot-6991.jpeg) no-repeat top center;padding: 5px 0px 0px 0px;background-size: 100% 100% !important;">
	<div class="h35"></div>
		...
		<div class="container">
			...
			<a href="/"><img style="width: 150px;background: #fff;border-radius: 5px;" alt="logo" src="https://hoabinhbooking.com/public/frontend/css/images/logohoabinhbooking.png"></a>
			</div>

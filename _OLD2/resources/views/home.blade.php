...
<div class="toppages">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-2 col-sm-2 col-xs-12">
					<a href="/">
						<img class="logo" alt="" src="public/frontend/css/images/logohoabinhbooking.png"/>
					</a>
				</div>
	...
	<div class="MuiBox-root jss16 jss5">
		...
		<!--<video width="100%" height="488px" type="video/mp4" autoplay="" muted="" loop=""><source src="public/frontend/css/images/1015169080-preview.mp4">Your browser does not support the video tag.</video>-->
	</div>
	<div class="jsc11">
		<div class="jsc12">
			<div class="row">
			...
			<div class="f__b__l">
				...
				<div class="f__b__l_1_2">
					...
					<div class="f__b__l_1_4">
						<i class="fa fa-map-marker" aria-hidden="true"></i> Thành Phố Thanh Hóa
					</div>
		...
		<div class="row">
		   <div class="col-lg-3 col-md-6">
			  <div class="destination-item ">
				 <a href="https://hoabinhbooking.com/vi/hotel?location_id=31">
		   ...
		   <div class="col-lg-3 col-md-6">
			  <div class="destination-item ">
				 <a href="https://hoabinhbooking.com/vi/hotel?location_id=30">
		   ...
		   <div class="col-lg-3 col-md-6">
			  <div class="destination-item ">
				 <a href="https://hoabinhbooking.com/vi/hotel?location_id=29">
		   ...
		   <div class="col-lg-3 col-md-6">
			  <div class="destination-item ">
				 <a href="https://hoabinhbooking.com/vi/hotel?location_id=19">
...
<div class="bravo_footer" style="background: url(https://hoabinhbooking.com/public/images/bgfoot-6991.jpeg) no-repeat top center;padding: 5px 0px 0px 0px;background-size: 100% 100% !important;">
	<div class="h35"></div>
		...
		<div class="container">
			...
			<img style="width: 150px;background: #fff;border-radius: 5px;" alt="logo" src="{{ asset('public/frontend/css/images/logohoabinhbooking.png') }}">
			</div>
